...
-- 1 JOIN with rep_cust_az12 to get BDATE and GEN
left join silver.rep_cust_az12 as ca
	on ci.cst_key = ca.CID
left join silver.rep_loc_a101 as la
...
-- 2 JOIN with rep_px_cat_g1v2 to get cat, subcat and maintenance
left join silver.rep_px_cat_g1v2 as pc
	on pn.cat_id = pc.id
...
/* RECHECK after create view : Foreign Key Integrity (Dimensions)
GO
select *
...
select *
from gold.fac_sales as f
left join gold.dim_product as c
